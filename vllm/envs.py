...
if TYPE_CHECKING:
    ...
    VLLM_KV_LIFECYCLE_TRACE_DIR: str | None = None
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # If set, write engine-side request/KV lifecycle traces as JSONL files.
    "VLLM_KV_LIFECYCLE_TRACE_DIR": lambda: os.getenv("VLLM_KV_LIFECYCLE_TRACE_DIR"),
